...
```js
grunt.loadNpmTasks('grunt-mswebdeploy-package');
```

## The "mswebdeploy_package" task

### Overview
In your project's Gruntfile, add a section named `mswebdeploy_package` to the data object passed into `grunt.initConfig()`.
